# `.loomtide/` — Loomtide project state (skeleton)

This directory is the **single source of truth** for Loomtide's plan → build →
...
```bash
loomtide plan        # scaffolds the contract + design target into this directory
```
