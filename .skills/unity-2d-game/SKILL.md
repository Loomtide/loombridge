---
name: unity-2d-game
description: Build, modify, and playtest Unity 2D games through Loombridge MCP tools, with locked 2D project structure, slice-friendly construction, and verified player feel.
---

Use this skill for Loombridge-driven Unity 2D implementation. For polish components, especially player
...
3. Keep Loombridge core generic; game-specific behavior lives in authored scripts.
4. Use the **new Unity Input System** for every Loombridge-built 2D game or fixture:
   ...
   - Rationale: Loombridge input-driven verification cannot drive legacy `UnityEngine.Input`; legacy-only
...
6. Verify after each major slice with compile checks, screenshots, and the relevant `loombridge verify`
   command.
