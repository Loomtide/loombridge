...
export interface UnityDriverOptions {
  /**
   * Directory for capture PNGs (server-relative under `.loomtide/`|`captures/`,
   * or absolute under an allowed root). Default `.loomtide/replays/actual`.
   */
  captureDir?: string;
...
const DEFAULTS = {
  captureDir: ".loomtide/replays/actual",
