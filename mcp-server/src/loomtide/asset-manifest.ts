/**
 * Asset Manifest contract — `.loomtide/ASSET_MANIFEST.json`.
 *
...
export const ASSET_MANIFEST_SCHEMA_PATH = path.resolve(
  __dirname,
  "..",
  "..",
  "src",
...
export async function readAssetManifest(paths: LoomtidePaths): Promise<AssetManifest | null> {
  let raw: string;
  try {
...
export async function writeAssetManifest(paths: LoomtidePaths, manifest: AssetManifest): Promise<void> {
