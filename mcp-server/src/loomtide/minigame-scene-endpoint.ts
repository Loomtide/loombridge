 ...
 * `LOOMTIDE_TARGET_PROJECT_PATH` (an explicit user pin), if any.
 */
  ...
  if (pin) {
    ...
    return {
      ...
      message:
        ...
        + `Open that project's editor with the Loomtide bridge connected, or unset the pin.`,
      projects,
    };
  }
  ...
  if (projects.length === 0) {
    return {
      ...
      message:
        ...
        + "Loomtide bridge is connected, then re-run.",
      projects,
    };
  }
