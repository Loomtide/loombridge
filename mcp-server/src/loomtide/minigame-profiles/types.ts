 ...
 */
export { WORKSPACE_ID_PATTERN as MINIGAME_ID_PATTERN } from "../workspace-paths.js";
...
/**
 * A scene object locator. Loomtide uses `SceneName:/Path/To/Object[index]` (or a
...
export interface MinigameState {
   ...
   * each round. Loomtide is read-only (no RNG seed, no game-code change), so it does NOT
 ...
 * regression (its own tier). Approve the bundle with `loomtide minigame baseline approve`.
 */
