 ...
 * a healthy `jumpApex` sits in THIS band". `loombridge verify` selects a profile and
 ...
 *
 * Aligned with `FeelSection` (`mcp-server/src/capabilities/verification/types.ts`) + the
