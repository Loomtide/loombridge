...
const REGISTRY: Record<string, GenrePackRegistration> = {
  "platformer-2d": {
    id: "platformer-2d",
    // The acceptance template (tiderunner) stays under src/capabilities/verification/ — it doubles as a shared
    ...
    acceptanceTemplatePath: path.join(PKG_ROOT, "src", "capabilities", "verification", "tiderunner.acceptance.json"),
    sliceTemplatePath: path.join(PKG_ROOT, "src", "capabilities", "genre", "genre-packs", "platformer-2d", "slices.json"),
  ...
  "2d-shooter": {
    id: "2d-shooter",
    acceptanceTemplatePath: path.join(PKG_ROOT, "src", "capabilities", "genre", "genre-packs", "2d-shooter", "acceptance.json"),
    sliceTemplatePath: path.join(PKG_ROOT, "src", "capabilities", "genre", "genre-packs", "2d-shooter", "slices.json"),
  ...
  "3d-shooter": {
    id: "3d-shooter",
    acceptanceTemplatePath: path.join(PKG_ROOT, "src", "capabilities", "genre", "genre-packs", "3d-shooter", "acceptance.json"),
    sliceTemplatePath: path.join(PKG_ROOT, "src", "capabilities", "genre", "genre-packs", "3d-shooter", "slices.json"),
