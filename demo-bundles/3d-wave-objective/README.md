...
First live **wave/objective** capture, taken in the repo-owned `unity-projects/shooter-3d-combat-dogfood`
...
| `generate.mjs` | Assembles the derived artifact FROM the raw transcript through the production `deriveWaveObjectiveComplete` (series copied verbatim). Run: `node demo-bundles/3d-wave-objective/generate.mjs`. |
