...
const artifact = {
  ...
  provenance: {
    ...
    note:
      "Generated by demo-bundles/3d-shooter-first-live-capture/generate.mjs from the committed raw runtime.capture_input_motion transcript using production feel-derive calculators.",
  },
};
