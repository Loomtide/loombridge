...
First live **cover** capture pair, taken in the repo-owned `unity-dev-project/shooter-3d-combat-dogfood`
...
| `generate.mjs` | Assembles the derived artifact FROM both raw transcripts through the production `deriveCoverBlocksDamage` (series copied verbatim). Run: `node demos/evidence-bundles/3d-cover-proof/generate.mjs`. |
