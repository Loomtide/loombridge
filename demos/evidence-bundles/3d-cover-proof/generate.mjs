...
const artifact = {
  ...
  project:
    `${coveredRaw.host?.projectName} (repo-owned 3D shooter fixture; unity-dev-project/shooter-3d-combat-dogfood, ` +
    "scene Assets/Scenes/Shooter3DCombatDogfood.unity)",
  rawCaptureSources: [`demos/evidence-bundles/3d-cover-proof/${COVERED_RAW}`, `demos/evidence-bundles/3d-cover-proof/${EXPOSED_RAW}`],
  fixture: {
