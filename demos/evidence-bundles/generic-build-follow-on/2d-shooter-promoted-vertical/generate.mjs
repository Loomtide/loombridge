...
// Four levels: demos/evidence-bundles/generic-build-follow-on/<bundle>/ -> repo root.
// (The consolidation added a level; a ".."-count encodes depth and silently mis-resolves
// when the tree moves, which is exactly what happened here.)
...
const ttkHostLiveArtifact = {
  ...
  rawCaptureSource: `demos/evidence-bundles/generic-build-follow-on/2d-shooter-promoted-vertical/${HOST_RAW_REL}`,
  fixture: {
...
// fixture (`unity-dev-project/shooter-combat-dogfood`, scene Assets/Scenes/ShooterCombatDogfood.unity). This
...
const ttkShooterArtifact = {
  ...
  project:
    ...
    "unity-dev-project/shooter-combat-dogfood, scene Assets/Scenes/ShooterCombatDogfood.unity)",
  rawCaptureSource: `demos/evidence-bundles/generic-build-follow-on/2d-shooter-promoted-vertical/${SHOOTER_RAW_REL}`,
  fixture: {
...
const impactProvenance = {
  ...
  project:
    ...
    "unity-dev-project/shooter-combat-dogfood, scene Assets/Scenes/ShooterCombatDogfood.unity)",
  rawCaptureSource: `demos/evidence-bundles/generic-build-follow-on/2d-shooter-promoted-vertical/${IMPACT_RAW_REL}`,
...
const proof = {
  ...
  genreContract,
  promotion: {
    generatedAcceptance: "demos/evidence-bundles/generic-build-follow-on/2d-shooter-promoted-vertical/acceptance.json",
    generatedSlices: "demos/evidence-bundles/generic-build-follow-on/2d-shooter-promoted-vertical/slices.json",
    promotionReport: "demos/evidence-bundles/generic-build-follow-on/2d-shooter-promoted-vertical/promotion-report.json"
  },
  slice: {
    id: "weapon",
    ...
    gateEvidence: [
      {
        gate: "manifest",
        status: "pass",
        artifact: "demos/evidence-bundles/generic-build-follow-on/evidence/weapon-manifest.json",
      ...
      },
      {
        gate: "console-clean",
        status: "pass",
        artifact: "demos/evidence-bundles/generic-build-follow-on/evidence/weapon-console.json",
    ...
    metricEvidence: [
      {
        ...
        status: "pass",
        artifact: "demos/evidence-bundles/generic-build-follow-on/live-unity-fire-dogfood/live-fire-capture-2026-06-25.json",
      ...
      },
      {
        ...
        status: "pass",
        artifact: "demos/evidence-bundles/generic-build-follow-on/live-unity-projectile-speed/live-projectile-speed-capture-2026-06-25.json",
      ...
      },
      {
        ...
        status: "pass",
        artifact: "demos/evidence-bundles/generic-build-follow-on/live-unity-input-spawn-latency/live-input-spawn-capture-2026-06-25.json",
