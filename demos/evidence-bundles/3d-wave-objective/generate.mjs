...
import { deriveWaveObjectiveComplete, firstRisingEdge } from "../../../mcp-server/dist/capabilities/verification/feel-derive.js";
...
const artifact = {
  ...
  rawCaptureSource: `demos/evidence-bundles/3d-wave-objective/${RAW_NAME}`,
  fixture: {
