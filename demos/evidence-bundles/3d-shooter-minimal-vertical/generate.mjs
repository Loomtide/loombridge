...
const verticalDerived = {
  ...
  rawCaptureSource: `demos/evidence-bundles/3d-shooter-minimal-vertical/${RAW_NAME}`,
  note:
...
for (const spec of bundleSpecs) {
  ...
  bundleCapabilities.push({
    ...
    derivedArtifact: `demos/evidence-bundles/${spec.derived}`,
    phase: spec.phase,
  });
}
...
const manifest = {
  ...
  capturedAt: raw.capturedAt,
  fixture: "unity-dev-project/shooter-3d-combat-dogfood (Assets/Scenes/Shooter3DCombatDogfood.unity)",
  ...
  gaps,
  sourceBundles: [
    "demos/evidence-bundles/3d-shooter-minimal-vertical/ (core loop, this bundle)",
    "demos/evidence-bundles/3d-shooter-first-live-capture/ (#316, original core loop)",
    "demos/evidence-bundles/3d-projectile-speed-substrate/ (#320)",
    "demos/evidence-bundles/3d-aim-turn-rate-substrate/ (#325)",
    "demos/evidence-bundles/3d-impact-feedback/ (#328)",
    "demos/evidence-bundles/3d-hitscan-weapon/ (#331)",
    "demos/evidence-bundles/3d-ai-reaction/ (#333)",
    "demos/evidence-bundles/3d-cover-proof/ (#338)",
    "demos/evidence-bundles/3d-wave-objective/ (#342)",
  ],
};
