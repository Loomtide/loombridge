...
| `generate.mjs` | Re-derives the core loop from the raw + rolls up the 8 phase bundles → manifest + report + derived. Run: `node demos/evidence-bundles/3d-shooter-minimal-vertical/generate.mjs`. |
