...
import { deriveHitscanImpactLatencyMs, firstRisingEdge } from "../../../mcp-server/dist/capabilities/verification/feel-derive.js";
...
const artifact = {
  ...
  rawCaptureSource: `demos/evidence-bundles/3d-hitscan-weapon/${RAW_NAME}`,
  fixture: {
