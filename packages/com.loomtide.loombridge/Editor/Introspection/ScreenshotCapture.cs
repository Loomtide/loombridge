...
namespace UnityBridge.Introspection
{
    ...
    public static class ScreenshotCapture
    {
        ...
        private static Camera CreateFocusCamera(GameObject target, float aspect, float padding)
        {
            ...
            var tempGo = new GameObject("~LoombridgeFocusCam") { hideFlags = HideFlags.HideAndDontSave };
        ...
        private static void CompositeOverlayCanvasesOnto(Texture2D dst, int width, int height)
        {
            ...
            var camGo = new GameObject("__LoombridgeUICompositeCam") { hideFlags = HideFlags.HideAndDontSave };
            ...
            {
                Debug.LogWarning($"[Loombridge] overlay UI compositing skipped: {ex.Message}");
            }
            finally
            {
