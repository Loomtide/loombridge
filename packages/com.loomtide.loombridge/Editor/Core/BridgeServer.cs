...
namespace UnityBridge.Core
{
    ...
    public class BridgeServer
    {
        ...
        private const string TransportModeEnvVar = "LOOMBRIDGE_UNITY_TRANSPORT_MODE";
        private const string DiscoveryDirEnvVar = "LOOMBRIDGE_ENDPOINT_DISCOVERY_DIR";
        ...
        private bool TryStartIpcTransport(out string reason)
        {
            ...
            {
                string pipeName = $"loombridge-bridge-{SessionId}".ToLowerInvariant();
        ...
        private void InitializeDiscoveryPaths()
        {
            ...
            _discoveryDirectoryPath = string.IsNullOrWhiteSpace(overrideDir)
                ? Path.Combine(ResolveDiscoveryTempBase(), "loombridge", "unitybridge")
                : overrideDir;
        ...
        /// back to Path.GetTempPath(). LOOMBRIDGE_ENDPOINT_DISCOVERY_DIR overrides this entirely.
        /// </summary>
