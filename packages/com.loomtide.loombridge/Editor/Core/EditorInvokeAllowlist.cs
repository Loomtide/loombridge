...
namespace UnityBridge.Core
{
    ...
    /// `&lt;projectRoot&gt;/.loombridge/editor-allowlist.json`:
    /// <code>
    /// {
    ...
    internal sealed class EditorInvokeAllowlist
    {
        ...
        internal const string ConfigRelativePath = ".loombridge/editor-allowlist.json";
        ...
        internal static EditorInvokeAllowlist LoadFrom(string projectRoot)
        {
            ...
            if (configPath != null && File.Exists(configPath))
            {
                ...
                {
                    Debug.LogWarning($"[Loombridge] Ignoring malformed {ConfigRelativePath}: {ex.Message}");
                }
            }
