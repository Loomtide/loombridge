...
namespace UnityBridge.UI
{
    ...
    /// </summary>
    public partial class LoombridgeAssetPicker : EditorWindow
    {
        ...
        {
            var window = GetWindow<LoombridgeAssetPicker>(utility: false);
            window.titleContent = new GUIContent("Loombridge Asset Picker");
        ...
        public static void ClosePicker()
        {
            ...
            if (HasOpenInstances<LoombridgeAssetPicker>())
            {
                var window = GetWindow<LoombridgeAssetPicker>(utility: false);
        ...
        private void Rebuild()
        {
            ...
            if (_slots.Count == 0)
            {
                var empty = new Label(
                    ...
                    + "The Loombridge agent opens this window with asset options for you to confirm or "
