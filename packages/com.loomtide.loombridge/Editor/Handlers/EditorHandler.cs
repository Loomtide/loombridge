...
namespace UnityBridge.Handlers
{
    ...
    public class EditorHandler : IOpHandler
    {
        ...
        /// default; a project opts each one in via menuItems[] in .loombridge/editor-allowlist.json.
        ...
        // took the blame. This op measures that weight so the advisory report (loombridge
        ...
        private JObject HandleAuditMobileAssets(JObject parameters)
        {
            ...
            var result = new JObject
            {
                // Payload discriminator: `loombridge mobile-audit` REFUSES any --input file that
