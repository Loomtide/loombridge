...
namespace UnityBridge.Runtime
{
    ...
    public sealed class InputSystemRuntimePump : MonoBehaviour
    {
        ...
        private static void EnsureInstance()
        {
            ...
            var go = new GameObject("[UnityBridge] InputSystemRuntimePump");
        ...
        private static void EnsureVirtualKeyboard()
        {
            ...
            _virtualKeyboard = InputSystem.AddDevice<Keyboard>("[UnityBridge] VirtualKeyboard");
        }
        ...
        private static void EnsureVirtualMouse()
        {
            ...
            _virtualMouse = InputSystem.AddDevice<Mouse>("[UnityBridge] VirtualMouse");
        }
